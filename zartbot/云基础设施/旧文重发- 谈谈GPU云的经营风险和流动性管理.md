# 旧文重发:  谈谈GPU云的经营风险和流动性管理

> 作者: zartbot  
> 日期: 2025年12月11日 12:15  
> 原文: http://mp.weixin.qq.com/s?__biz=MzUxNzQ5MTExNw==&mid=2247496863&idx=1&sn=d09383c975f2f0217e92ee811772660c&chksm=f995e45dcee26d4b8b55afedf0741ae2a31ace1aca2f0ef60e8a9eb0bf00e931e19aa229d7ed#rd
...
这篇文章是几个月前写的.Oracle盘前跌了12%, 正好应验了这篇文章中的很多风险. 简单来说, 上杠杆容易, 管理流动性风险是一个难题.

![图片](assets/01b8867143cd.png)
...
这也是为什么云的计算部门都会叫`弹性计算`, 无论是AWS的EC2(Elastic Compute Cloud)还是阿里云的ECS(Elastic Compute Service). 弹性计算本质上和线下IDC机房卖铁有很多的区别, 前段时间写了一篇文章关于云计算弹性的文章

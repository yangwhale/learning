...
*Table 41: Shared memory descriptor layout*

| Bit-field | Size in bits | Description |
| --- | --- | --- |
| 0-13 | 14 | matrix-descriptor-encode (Matrix start address) |
| 16-29 | 14 | matrix-descriptor-encode (*Leading dimension byte offset*) |
...
| 52 | 1 | Fixed constant value of 0xb0 |
...
*Figure 224: tcgen05.mma with block scaling of scale_vec::2X*
